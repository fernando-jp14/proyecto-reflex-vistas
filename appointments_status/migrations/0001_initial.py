    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['name'],
                'indexes': [models.Index(fields=['name'], name='appointment_name_b2e8b6_idx')],
            },
        ),
        migrations.CreateModel(
            name='Ticket',
            ...
            options={
                ...
                'indexes': [models.Index(fields=['ticket_number'], name='tickets_ticket__4c9624_idx'), models.Index(fields=['payment_date'], name='tickets_payment_5ac8c0_idx'), models.Index(fields=['status'], name='tickets_status_fbbf05_idx')],
            },
        ),
        migrations.CreateModel(
            name='Appointment',
            fields=[
                ...
                ('appointment_type', models.CharField(blank=True, max_length=100, null=True, verbose_name='Tipo de cita')),
                ('room', models.CharField(blank=True, max_length=50, null=True, verbose_name='Habitación/Consultorio')),
                ('social_benefit', models.CharField(blank=True, max_length=100, null=True, verbose_name='Beneficio social')),
                ('payment_detail', models.TextField(blank=True, null=True, verbose_name='Detalle de pago')),
                ('payment', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Pago')),
                ('ticket_number', models.CharField(blank=True, max_length=50, null=True, verbose_name='Número de ticket')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creación')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Fecha de actualización')),
                ('is_active', models.BooleanField(default=True, verbose_name='Activo')),
                ('appointment_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='appointments_status.appointmentstatus', verbose_name='Estado de la cita')),
            ],
            options={
                'verbose_name': 'Cita',
                ...
                'indexes': [models.Index(fields=['appointment_date', 'appointment_hour'], name='appointment_appoint_68d4d0_idx'), models.Index(fields=['appointment_status'], name='appointment_appoint_b25c11_idx')],
            },
        ),
    ]
