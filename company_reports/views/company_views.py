...
from company_reports.serializers.company_serializers import CompanyDataSerializer, UploadImageRequest
from company_reports.services.company_services import CompanyService
